...
class PaletteMetaForm extends Component {
    ...
    render() {
        ...
        return (
            <div>
                <Dialog open={isShowingForm && (showFormOf === "emoji")} onClose={hidePaletteForm}>
                    <DialogContent>
                    ...
                    <DialogActions>
                        <Button variant="contained" color="primary" onClick={this.passPalette}>
                            Save
                        </Button>
                    </DialogActions>
                </Dialog>
                <Dialog open={isShowingForm && (showFormOf === "paletteName")} onClose={hidePaletteForm} aria-labelledby="form-dialog-title" >
                    <DialogTitle id="form-dialog-title">Choose a palette name</DialogTitle>
                    <ValidatorForm onSubmit={this.nextStage} autoComplete="off">
                        <DialogContent>
                            <DialogContentText style={{ fontWeight: "bolder" }}>
                                Please enter the name for the Palette to be saved and make sure its unique
                            </DialogContentText>
                            <TextValidator
                                label="Palette Name"
                                name='newPaletteName'
